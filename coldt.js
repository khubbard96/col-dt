...
//constructor
COLDataTable = function(options) {

}

//instance methods
COLDataTable.prototype.placeholder = function() {}

//static methods
COLDataTable.placeholder = function() {}


(function(){
    //initialize anything that needs to happen before everything else
...
const COLDataTable = function() {
    this.contents = [],
    this.page = 0, //current page number, starting at 0
    this.maxPages = -1,
    this.perPage = 25,
    this.columnOrder = [],
    this.widget = undefined,
    this.container = $("#leads_list"),
    this.sort = "",
    this.sortProp = "",
    this.data = {
    ...
    this.permission = {//this contains all of the relevant permission information for the table
        applied: false,
        level: -1,
        NONE: 0,
        VIEW: 1,
    ...
    this.init = function () {
        ...
        Object.defineProperty(self.data, "rowsSelected", {
            set: function (rows) {
                self.container.find("#bulk_edit_lead_header .number-selected").text(rows.length + LeadTrackingTranslation.dbRes("leads_LeadsSelected") + ".");
    ...
    this._appendInline = function ($html) {
    ...
    this._applyPermission = function () {
        //LEAD PERMISSIONS                    
    ...
    this._hideHiddenColumns = function () {
    ...
    this.reorderColumns = function (render) {
        let self = Leads.UI.Widgets.options.list.Table;
    ...
    this.dropdowns = {},
    this.updateDropdowns = function (dropdown) {
        let self = Leads.UI.Widgets.options.list.Table;
        let container = self.container;
        let results;
